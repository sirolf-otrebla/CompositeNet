...
class CompositeConv(LayerBase):
    ...
    # selects the relative K nearest neighbours
    # normalize everything to be inside the unitary topological disc
    # extract the features corresponding to each examined point
